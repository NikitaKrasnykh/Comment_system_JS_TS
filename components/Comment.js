...
export default function CommentComponent(comment, replyes) {
    return `
  ...
  <div class="comments__main-comment">
      ...
      <div class="comments__comment-panel">
        ...
        <button class="comments__comment-btn js-like-comment" type="button" data-liked="${comment.isLiked}" data-comment="${comment.id}">
          <img class="comments__comment-fav-img" src="${comment.isLiked ? './Images/fav_button_selected.png' : './Images/fav_button_unselected.png'}" alt="в избранное">
          В избранное
        </button>
